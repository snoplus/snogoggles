////////////////////////////////////////////////////////////////////////
/// \class Viewer::Frames::Histo
///
/// \brief   Histo drawing frame
///
...
#ifndef __Viewer_Frames_Histo__
#define __Viewer_Frames_Histo__
...
class Histo : public Frame
{
public:
  Histo( RectPtr rect ) : Frame( rect ) { }
  ~Histo();
  ...
  virtual std::string GetName() { return Histo::Name(); }
  
  static std::string Name() { return std::string( "Histo" ); }
