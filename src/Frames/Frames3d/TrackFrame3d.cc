...
void TrackFrame3d::CreateGUIObjects()
{
    ...
    fModuleManager->fCameraManager->CreateGUIObjects( fGUIManager, sf::Rect<double>( 0, 0.96, 0.5, 0.04 ) );
	fModuleManager->fAxes->CreateGUIObjects( fGUIManager, sf::Rect< double >( 0.5, 0.96, 0.23, 0.04 ) );
	fModuleManager->fGeoManager->CreateGUIObjects( fGUIManager, sf::Rect< double >( 0.75, 0.96, 0.23, 0.04 ) );
