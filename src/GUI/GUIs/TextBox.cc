  ...
  : GUI( rect, guiID )
{
  ...
  fMiddleBox[0] = textureManager.GetTexture( 46, eBase );
  fMiddleBox[1] = textureManager.GetTexture( 46, eHighlight );
  fMiddleBox[2] = textureManager.GetTexture( 46, eActive );
  fRightBox[0] = textureManager.GetTexture( 47, eBase );
  fRightBox[1] = textureManager.GetTexture( 47, eHighlight );
  fRightBox[2] = textureManager.GetTexture( 47, eActive );
